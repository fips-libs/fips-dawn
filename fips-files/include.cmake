if (USE_DAWN_SDK)
    ...
    add_library(dawncpp STATIC IMPORTED)
    set_target_properties(dawncpp PROPERTIES IMPORTED_LOCATION "${DAWN_BUILD_DIR}/src/dawn/${DAWN_LIB_PREFIX}dawncpp${DAWN_LIB_SUFFIX}")
    target_link_libraries(dawncpp INTERFACE webgpu_dawn)
    ...
    if (FIPS_MACOS)
        target_link_libraries(glfw3 INTERFACE "-framework Cocoa" "-framework IOKit")
    endif()
